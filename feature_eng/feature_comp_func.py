...
_MAIN_DIR = os.path.dirname(_FEATURE_ENG_DIR)
_STANDALONE_DIR = os.path.join(_FEATURE_ENG_DIR, "feature_extraction_standalone_files")
...
_HUMAN_IDR_SEQUENCES_CSV = os.path.join(_MA, "datasets", "human_IDR_sequences.csv")
